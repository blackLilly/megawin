!function (r) {
    ...
    function n(a) {
        ...
        return r[a].call(o.exports, o, o.exports, n),
            o.l = !0,
            o.exports
    }
    n.m = r,
    ...
    var o = n.colorapp = new function () {
        this.currentColor = null,
            this.init = function () {
                ...
                this.currentColor = t ? r.HEXtoRGB(t) : this.randomColor(),
                ...
                setTimeout(function () {
                    ...
                    $("#random-tip .text").on("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
                        $(this).removeClass("bounceInDown jello animated")
                    }),
                    $(document).on("keyup", function (t) {
                        18 == t.keyCode && ($("#random-tip .text").addClass("jello animated"),
                            r.currentColor = r.randomColor(),
                            r.setColorFields(!1),
                            r.setSiteColor(!0))
                    }),
                    window.addEventListener("hashchange", function () {
                        var t = location.hash.substring(6);
                        t && (r.currentColor = r.HEXtoRGB(t),
                            r.setColorFields(!1),
                            r.setSiteColor(!1))
                    })
            }
            ...
            this.setSiteColor = function (r) {
                ...
                if (this.RGBlightness(t[0], t[1], t[2]) < 180)
                    var a = this.blendColors(n, "#FFFFFF", .75);
                else
                    a = this.blendColors(n, "#000000", .5);
                $("#mathcolorapp").css("backgroundColor", "rgb(" + t + ")"),
                    $(".color-field, a").css("color", a),
            ...
            this.changeColor = function (r) {
                ...
                switch ($(r).attr("id")) {
                    ...
                    case "rgb":
                        ...
                        break;
                    case "cmyk":
                        o = t.matchers().cmyk.exec(r.value),
                            a = t.CMYKtoRGB(o[1], o[2], o[3], o[4]),
                            n = "cmyk";
                        break;
                    case "hsl":
                        e = t.matchers().hsl.exec(r.value),
                            a = t.HSLtoRGB(e[1], e[2], e[3]),
                            n = "hsl";
                        break;
                    default:
                        a = !1,
            ...
            this.setColorFields = function (r) {
                var t = this.currentColor;
                if ("hex" != (r = r || !1) && $("#hex").val("#" + this.RGBtoHEX(t[0], t[1], t[2])),
                    "rgb" != r && $("#rgb").val("rgb(" + t.join(",") + ")"),
                    "hsl" != r) {
            ...
            this.RGBtoHEX = function (r, t, n) {
                var a;
                return a = (r << 16 | t << 8 | n).toString(16).toUpperCase(),
                    new Array(7 - a.length).join("0") + a
            }
            ,
            this.HEXtoRGB = function (r) {
                return r = String(r).replace(/[^0-9a-f]/gi, ""),
                    [(r = parseInt(r, 16)) >> 16, r >> 8 & 255, 255 & r]
            }
            ,
            this.RGBtoBIN = function (r, t, n) {
                var a;
                return a = (r << 16 | t << 8 | n).toString(2),
                    new Array(25 - a.length).join("0") + a
            }
            ,
            ...
            this.RGBtoHSL = function (r, t, n) {
                ...
                if (r /= 255,
                    t /= 255,
                    n /= 255,
                    s = ((a = Math.max(r, t, n)) + (o = Math.min(r, t, n))) / 2,
                    a == o)
                    e = i = 0;
                else {
                    switch (h = a - o,
            ...
            this.HSLtoRGB = function (r, t, n) {
                var a, o, e, i, s, h;
                return r = Number(String(r).replace(/[^0-9\.]/gi, "")),
                    ...
                    h = (s = (1 - Math.abs(2 * n - 1)) * t) * (1 - Math.abs(r % 2 - 1)),
                    r < 1 ? (a = s,
                        o = h,
                        e = 0) : r < 2 ? (a = h,
                            o = s,
                                ...
                                e = h) : r < 4 ? (a = 0,
                                    ...
                                    e = s) : r < 5 ? (a = h,
                                        ...
                                        e = s) : (a = s,
                                            ...
                                            e = h),
                    i = n - s / 2,
                    [a = Math.round(255 * (a + i)), o = Math.round(255 * (o + i)), e = Math.round(255 * (e + i))]
            }
            ,
            this.RGBtoHSV = function (r, t, n) {
                ...
                if (v = o,
                    ...
                    var i = ((o - r) / 6 + e / 2) / e
                        , u = ((o - t) / 6 + e / 2) / e
                        , c = ((o - n) / 6 + e / 2) / e;
                    r == o ? h = c - u : t == o ? h = 1 / 3 + i - c : n == o && (h = 2 / 3 + u - i),
                        h < 0 && (h += 1),
                        h > 1 && (h -= 1)
                }
                return h = Math.round(360 * h),
                    s = Math.round(100 * s),
                    v = Math.round(100 * v),
                    [h, s, v]
            }
                ...
                return t /= 360,
                    ...
                    0 == (n /= 100) ? (r = 255 * a,
                        ...
                        b = 255 * a) : (var_h = 6 * t,
                            ...
                            var_1 = a * (1 - n),
                            var_2 = a * (1 - n * (var_h - var_i)),
                            var_3 = a * (1 - n * (1 - (var_h - var_i))),
                            0 == var_i ? (var_r = a,
                                var_g = var_3,
                                var_b = var_1) : 1 == var_i ? (var_r = var_2,
                                    var_g = a,
                                    var_b = var_1) : 2 == var_i ? (var_r = var_1,
                                        var_g = a,
                                        var_b = var_3) : 3 == var_i ? (var_r = var_1,
                                            var_g = var_2,
                                            var_b = a) : 4 == var_i ? (var_r = var_3,
                                                var_g = var_1,
                                                var_b = a) : (var_r = a,
                                                    var_g = var_1,
                                                    var_b = var_2),
                            r = Math.round(255 * var_r),
                            g = Math.round(255 * var_g),
                            b = Math.round(255 * var_b)),
                    [r, g, b]
            }
            ,
            this.CMYKtoRGB = function (t, n, a, o) {
                return t /= 100,
                    ...
                    a /= 100,
                    o /= 100,
                    r = 1 - Math.min(1, t * (1 - o) + o),
                    g = 1 - Math.min(1, n * (1 - o) + o),
                    b = 1 - Math.min(1, a * (1 - o) + o),
                    r = Math.round(255 * r),
                    g = Math.round(255 * g),
                    b = Math.round(255 * b),
                    [r, g, b]
            ...
            this.colorLuminance = function (r, t) {
                (r = String(r).replace(/[^0-9a-f]/gi, "")).length < 6 && (r = r[0] + r[0] + r[1] + r[1] + r[2] + r[2]),
                    t = t || 0;
                var n, a, o = "#";
                for (a = 0; a < 3; a++)
                    n = parseInt(r.substr(2 * a, 2), 16),
                        Math.min(Math.max(0, n + n * t), 255) < -100 * t && (t *= -1),
                        o += ("00" + (n = Math.round(Math.min(Math.max(0, n + n * t), 255)).toString(16))).substr(n.length);
                return o
            }
            ,
